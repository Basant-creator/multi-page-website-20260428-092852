...
Multi page website for a law firm with simple and minimalistic UI with About page and contact details tab
...
> to open Find & Replace across all files. Search for `Smith's Firm` and replace it with your brand name everywhere at once.
...
|----------------|-------------|------------------------------|
| Company name (`Smith's Firm`) | All `.html` files | Use Find & Replace to update it everywhere |
